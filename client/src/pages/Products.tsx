...
const products = [
  {
    id: "satellite-bus",
    icon: Satellite,
    title: "Autonomous EO Satellite ",
    tagline: "Smart satellites that work independently.",
    description:
      "High-reliability Earth observation platform with continuous availability. From 10U CubeSats to 500 kg bus configurations, optimized for reduced ground operations.",
  ...
  },
  {
    ...
    description:
      "Intelligent satellite operating system featuring autonomous tasking, scheduling, and fault-protection. Operates even without constant ground link.",
    image: uiImage,
  ...
  },
  {
    ...
    description:
      "Revolutionary satellite imagery platform that makes accessing Earth observation data simple, fast, and accessible for everyone.",
    image: cameraImage,
          ...
          <SectionReveal>
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                From autonomous satellite platforms to intelligent operating
                systems, our products are designed to transform how you operate
                in space.
              </p>
            </div>
          </SectionReveal>
                ...
                <Card className="overflow-hidden border-0 shadow-xl">
                  ...
                  >
                    ...
                    >
                      ...
                      {product.badge && (
                        <Badge
                          className="absolute top-2 right-2 rounded-full px-3 py-1 text-xs sm:text-sm bg-gradient-to-r from-teal-500 to-cyan-500 text-white border-none shadow-lg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <SectionReveal>
            <h2
              ...
              data-testid="text-products-cta"
            >
              Need a Custom Solution?
            </h2>
            <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
              Our team can work with you to develop tailored satellite
              solutions that meet your specific mission requirements.
            </p>
            <Link href="/contact">
              <Button
                size="lg"
